...
![Ridge Results](Plots/Linear%20Regression.png)
...
![Logistic Regression Results](Plots/Logistic%20Regression.png)
...
**Underfitting:** depth=2-3 ხე ძალიან მარტივია, val_auc=0.50-0.67, ვერ ითვისებს fraud-ის ნიმუშებს.
...
![Decision Tree Results](Plots/Decision%20Tree.png)
...
![Random Forest Results](Plots/Random%20Forest.png)

---

### 5. GradientBoosting: Sequential Error Correction

n_estimators-ის sweep გამოვიყენე underfitting-დან სტაბილურ მდგომარეობაში გადასვლის სადემონსტრაციოდ.
...
![GradientBoosting Results](Plots/Gradient%20Boosting.png)
...
![XGBoost Results](Plots/XGBoost.png)
